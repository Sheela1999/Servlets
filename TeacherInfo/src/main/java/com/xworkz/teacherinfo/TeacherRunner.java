...
//		service.save(dto4);
		...
		boolean data = service.updateByNameAndId("'Rohini'", 4, "Digital Electronics");
		System.out.println(data);
		
		System.out.println("_________________________________deleteById__________________________________________________");
